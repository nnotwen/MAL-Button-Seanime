...
function init() {
    $ui.register((ctx: any) => {
         ...
         */
        const mediaToMalId = (media: any) => media?.idMal ? String(media.idMal) : null;
